    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary py-3">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Country</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-1">
                        ...
                        <input type="text" id="currency_name" name="currency_name" class="form-control " placeholder="Enter Currency Name"/>
                        <span class="text-danger currency_name_Error"></span>
                    </div>
                    <div class="col-12 mb-1">
                        <label for="currency_symbol" class="form-label">Currency Symbol <span class="text-danger">*</span></label>
                        <input type="text" id="currency_symbol" name="currency_symbol" class="form-control " placeholder="Enter Currency Symbol"/>
                        <span class="text-danger currency_symbol_Error"></span>
                    </div>
                    <div class="col-12 mb-1">
                        <label for="timezone" class="form-label">Select Time Zone <span class="text-danger">*</span></label>
                        <select name="timezone" id="timezone" class="form-control select2" style="display: block !important;">
                            <option></option>
                        ...
                        <span class="text-danger timezone_Error"></span>
                    </div>
                </div>
    ...
    <script>
        ...
        function addCountry(){
            ...
            $.ajax({
                ...
                url: "{{ route('admin.settings.country.store') }}",
