    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary py-3">
                <h5 class="modal-title text-white" id="exampleModalLabel1">Add About Section</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-0">
                        <label for="name" class="form-label">About Description<span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col mb-2">
                        <label for="image" class="form-label">About Image <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="img" style="margin: auto; text-align: center; vertical-align: middle; border: 1px solid #ddd; border-radius: 4px; padding: 4px; height: 250px; overflow: hidden;" >
                            <img id="image_id" class="img-fluid" style="height: 240px; width: auto;" src="{{ asset('uploads/system/').'/'.companyInfo()->website_logo }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
