...
<head>
    <title>Ayur Grean | Forget Password </title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" autocomplete="off" method="POST" action="{{ route('password.email') }}">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">{{ __('Email Password Reset Link') }}</button>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
