                ...
                initComplete: function(settings, json) {
                    ...
                    function updateFooterTotals() {
                        ...
                        dataTable.rows({
                            ...
                            var point = parseFloat(rowData.total_point);
                            if (!isNaN(point)) {
                                total_point += point;
                            }
                            var amount = parseFloat(rowData.sub_total);
                            if (!isNaN(amount)) {
                                total_amount += amount;
                            }
                        });
                        ...
                        $('#datatable tfoot th:eq(2)').text(total_amount.toFixed(2)); //Total Amount
                    }

                    // Add the footer row initially
                    $('#datatable').append('<tfoot class="text-center"><tr><th colspan="3" class="text-right">Total</th><th class="text-center"></th><th class="text-center"></th></th><th></th><th></th></tr></tfoot>');
