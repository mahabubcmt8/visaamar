                ...
                <div class="card-header card-title align-middle">
                    <div class="d-flex">
                        ...
                        <div class="w-50 text-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('user.customer.withdraw.create') }}"><i class="fa fa-plus-circle" aria-hidden="true"></i> Withdraw</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        $(function() {
            ...
            dataTable = $('#datatable').DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('#datatable').append('<tfoot class="text-center"><tr><th colspan="5" class="text-right">Total</th><th class="text-center"></th><th></th><th></th></tr></tfoot>');
