                            ...
                            <div class="swiper-wrapper">
                                @foreach ($tours as $tour)
                                    <div class="swiper-slide">
                                        <div class="package-card3" style="border: 1px solid #ccc">
                                            <a href="{{ route('tours.details', $tour->slug) }}" class="package-card-img">
                                                <img src="{{ asset($tour->image) }}" style="height: 300px;">
                                                <div class="batch two">
                                                    {{-- <span>Trending</span> --}}
                                                </div>
                                            </a>
                                            <div class="package-card-content">
                                                <div class="card-content-top">
                                                    <h5><a href="{{ route('tours.details', $tour->slug) }}">{{ $tour->title }}</a></h5>
                                                ...
                                                <div class="card-content-bottom">
                                                    <div class="price-area">
                                                        <span class="title">Starting Form:</span>
                                                        <h6><sub>$</sub>{{ $tour->regular_price }}</h6>
                                                        <span>Per Person</span>
                                                    </div>
                                                    <a href="javascript:void(0)" class="primary-btn2">Read More
