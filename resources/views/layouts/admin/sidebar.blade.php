...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.home') }}" class="brand-link">
        <img src="{{ asset('uploads/system/') . '/' . companyInfo()->admin_logo }}" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item {{ Request::is('admin/settings/company-info') ? 'menu-open' : '' }} {{ Request::is('admin/settings/home/home-page') ? 'menu-open' : '' }} {{ Request::is('admin/settings/country') ? 'menu-open' : '' }}  {{ Request::is('admin/settings/state') ? 'menu-open' : '' }}">
                <a href="javascript:" class="nav-link {{ Request::is('admin/settings/company-info') ? 'active' : '' }} {{ Request::is('admin/settings/home/home-page') ? 'active' : '' }}  {{ Request::is('admin/settings/state') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-cog"></i>
                    <p>Country <i class="fas fa-angle-left right"></i> </p>
                </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('admin.settings.country.create') }}" class="nav-link {{ Request::is('admin/settings/company-info') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Add Country</p>
                        </a>
                    </li>
            ...
            <li class="nav-item {{ Request::is('admin/settings/company-info') ? 'menu-open' : '' }} {{ Request::is('admin/settings/home/home-page') ? 'menu-open' : '' }} {{ Request::is('admin/settings/country') ? 'menu-open' : '' }}  {{ Request::is('admin/settings/state') ? 'menu-open' : '' }}">
                <a href="javascript:" class="nav-link {{ Request::is('admin/settings/company-info') ? 'active' : '' }} {{ Request::is('admin/settings/home/home-page') ? 'active' : '' }}  {{ Request::is('admin/settings/state') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-cog"></i>
                    <p>Tours <i class="fas fa-angle-left right"></i> </p>
                </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('admin.tour.create') }}" class="nav-link {{ Request::is('admin/settings/company-info') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Add Tour</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <form method="POST" action="{{ route('admin.logout') }}">
                    @csrf
                    <a type="button" class="nav-link" href="{{ route('admin.logout') }}"onclick="event.preventDefault();this.closest('form').submit();"><i class="nav-icon fas fa-sign-out-alt"></i>
                        <p> Logout </p>
                    </a>
                </form>
            </li>
