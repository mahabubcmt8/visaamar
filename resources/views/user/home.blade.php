                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card-profile-details">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="Agent" class="form-control" style="text-transform: capitalize;" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12 pb-3">
                                <div class="card animated-button1">
                                    ...
                                    <div class="card-footer bg-c-purple">
                                        <div class="row align-items-center">
                                            <div class="col-9">
                                                <p class="text-white m-b-0">{{ currency()['name'] }}</p>
                                            </div>
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12 pb-3">
                                <div class="card animated-button1">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h4 class="text-c-green">{{ currency()['symble'] }} {{ number_format(deposit_balance(), 2) }}</h4>
                                                <h6 class="text-muted m-b-0">Deposit Balance</h6>
                                            </div>
                                            <div class="col-4 text-right">
                                                <a href="{{ route('user.deposit.index') }}?approved_list">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12 pb-3">
                                <div class="card animated-button1">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h4 class="text-c-red">{{ currency()['symble'] }} {{ number_format(total_purchase_amount(), 2) }}</h4>
                                                <h6 class="text-muted m-b-0">Total Purchase</h6>
                                            </div>
                                            <div class="col-4 text-right">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-home4" role="tabpanel" aria-labelledby="pills-home-tab4">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-4 text-right">
                                                        <a href="{{ route('user.withdraw.index') }}?approved_list">
                                                            <i class="fa fa-file-text-o f-28"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="pills-profile44" role="tabpanel" aria-labelledby="pills-profile-tab44">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-4 text-right">
                                                        <a href="{{ route('user.withdraw.index') }}?rejected_list">
                                                            <i class="fa fa-file-text-o f-28"></i>
                                                        </a>
                                                    </div>
                                                </div>
